...
import Range from './icons/range.svg';
...
const Header = () => {
	...
	function archiveCLoser() {
		setIsOpen(false);
		callcontext.changeMenu(2);
	}

	return (
		<div className='headerCapsule'>
			<div className='menuBoxBackgrop'>
				<svg
					viewBox='0 0 500 150'
					...
					{' '}
					<path
						d='M507.05,10.36 C135.72,14.30 181.43,-18.25 99.60,162.33 L525.67,176.14 L501.41,155.42 Z'
						style={{
							stroke: 'none',
